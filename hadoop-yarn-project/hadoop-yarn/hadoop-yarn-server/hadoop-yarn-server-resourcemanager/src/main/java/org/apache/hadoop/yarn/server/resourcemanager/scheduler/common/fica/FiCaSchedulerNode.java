...
public class FiCaSchedulerNode extends SchedulerNode {
  ...
  public FiCaSchedulerNode(RMNode node) {
    ...
    this.availableResource.setGPUCores(node.getTotalCapability().getGPUCores());
    this.availableResource.setGPUId(node.getTotalCapability().getGPUId());
  }
  ...
  private synchronized void deductAvailableResource(Resource resource) {
    ...
    LOG.info("[*GPU DEBUG]: availableResource:"+availableResource+" - resource:" +resource);
    Resources.subtractFrom(availableResource, resource);
    LOG.info("[*GPU DEBUG]: usedResource:"+usedResource+" + resource:" +resource);
