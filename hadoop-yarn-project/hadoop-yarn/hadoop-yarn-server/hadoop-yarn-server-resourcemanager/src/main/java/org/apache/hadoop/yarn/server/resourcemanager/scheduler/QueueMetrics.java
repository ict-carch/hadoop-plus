...
public class QueueMetrics implements MetricsSource {
   ...
   * @author Tim
   * @date 2013-10-15
   * @description Added GPU
   */
  @Metric("Allocated GPU in cores") MutableGaugeInt allocatedGCores;
  //@Metric("Allocated GPU ids in cores") MutableGaugeInt[] allocatedGPUIds; //
 // List<Integer> allocatedGPUIds;
  ...
  @Metric("Avaliable GPU in cores") MutableGaugeInt availableGCores;
//  @Metric("Avaliable GPU ids in cores") MutableGaugeInt[] availableGPUIds; //
//  List<Integer> availableGPUIds;
 ...
 // @Metric("Pending GPU ids allocation in cores") MutableGaugeInt[] pendingGPUIds; 
 // List<Integer> pendingGPUIds;
 ...
 // @Metric("Reserved GPU Ids in cores") MutableGaugeInt reservedGPUIds;
//  List<Integer> reservedGPUIds;
...
//    if(limit.getGPUCores()>0)
//    	availableGPUIds.addAll(limit.getGPUId());
  }
  ...
  private void _incrPendingResources(int containers, Resource res) {
    ...
    pendingGCores.incr(res.getGPUCores());
  }
  ...
  private void _decrPendingResources(int containers, Resource res) {
    ...
    pendingGCores.decr(res.getGPUCores());
  }
  ...
  public int getAvaliableGPUCores(){
