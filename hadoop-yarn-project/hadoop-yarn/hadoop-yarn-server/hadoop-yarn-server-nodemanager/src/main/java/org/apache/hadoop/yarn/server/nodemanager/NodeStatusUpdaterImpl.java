...
public class NodeStatusUpdaterImpl extends AbstractService implements
  ...
  protected void serviceInit(Configuration conf) throws Exception {
    ...
    int gpuCores =
    	conf.getInt(
    	    YarnConfiguration.NM_GPU_CORES, YarnConfiguration.DEFAULT_NM_GPU_CORES);	
    //end lism
    ...
    this.totalResource.setGPUCores(gpuCores); //add by lism
    this.totalResource.setGPUId(gpuId);
    ...
    LOG.info("Initialized nodemanager for " + nodeId + ":" +
        ...
        " virtual-cpu-cores=" + virtualCores +" gpu-cores=" + gpuCores +" gpuId: " +gpuId.toString());
    //end lism
