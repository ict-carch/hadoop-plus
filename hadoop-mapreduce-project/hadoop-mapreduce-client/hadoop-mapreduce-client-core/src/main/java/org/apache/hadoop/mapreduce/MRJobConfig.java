...
public interface MRJobConfig {
  ...
  * @author Tim adn Lism
  * @date 2013-10-16
  * @description GPU parameters
  */
  public static final String MAP_GPU_CORES = "mapreduce.map.gpu.cores";
  public static final int DEFAULT_MAP_GPU_CORES = 1;
  
  public static final String MAP_GPU_PREFER = "mapreduce.map.gpu.prefer";
  public static final boolean DEFAULT_MAP_GPU_PREFER = false;
  ...
  */
  ...
  public static final int DEFAULT_REDUCE_GPU_CORES = 1;
  
  public static final String REDUCE_GPU_PREFER = "mapreduce.reduce.gpu.prefer";
  public static final boolean DEFAULT_REDUCE_GPU_PREFER = false;
